...
function glowBoard(pos) {
	...
	for (var i=0;i<squares.length;i++){
		if (i == index0) {
			...
			blink();
			winSound();
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(0, 105, 61)';}, 100);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(0, 168, 98)';}, 200);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(31, 219, 141)';}, 300);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(86, 240, 176)';}, 400);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(31, 219, 141)';}, 500);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(0, 168, 98)';}, 600);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(0, 105, 61)';}, 700);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(0, 168, 98)';}, 800);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(31, 219, 141)';}, 900);
			setTimeout(function() {bg1.style.backgroundColor = 'rgb(86, 240, 176)';}, 1000);
			setTimeout(function() {bg1.style.backgroundColor = '#d7f3f7';}, 1100);
		} else if (i == index1) {
			var bg2 = squares[i];
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(35, 43, 158)';}, 100);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(70, 78, 194)';}, 200);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(124, 132, 247)';}, 300);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(165, 170, 250)';}, 400);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(35, 43, 158)';}, 500);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(70, 78, 194)';}, 200);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(124, 132, 247)';}, 300);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(165, 170, 250)';}, 400);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(35, 43, 158)';}, 900);
			setTimeout(function() {bg2.style.backgroundColor = 'rgb(70, 78, 194)';}, 1000);
...
function blink() {
	...
	setTimeout(function() {body.style.backgroundColor = '#FAEBD7';}, 100);
	setTimeout(function() {body.style.backgroundColor = '#E6E6FA';}, 200);
	setTimeout(function() {body.style.backgroundColor = '#D3D3D3';}, 300);
	setTimeout(function() {body.style.backgroundColor = '#B0C4DE';}, 400);
	setTimeout(function() {body.style.backgroundColor = '#FAEBD7';}, 500);
	setTimeout(function() {body.style.backgroundColor = '#E6E6FA';}, 600);
	setTimeout(function() {body.style.backgroundColor = '#D3D3D3';}, 700);
	setTimeout(function() {body.style.backgroundColor = '#B0C4DE';}, 800);
	setTimeout(function() {body.style.backgroundColor = '#F0FFF0';}, 900);
	setTimeout(function() {body.style.backgroundColor = '#FAEBD7';}, 1000);
	setTimeout(function() {body.style.backgroundColor = '#E6E6FA';}, 1100);
}
